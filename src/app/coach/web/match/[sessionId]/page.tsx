...
/* Team stats now live in src/lib/match-team-stats.ts so both this
 * page and the Match Center calendar drill-in (State5Ready) read from
 * the same source — hand-authored entries for the 6 canonical mockData
 * sessions, deterministic synth for the rest. */
...
export default function CoachMatchAnalysisPage() {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-brand-sand font-satoshi text-brand-indigo">
      ...
      <V3MatchStats stats={getMatchTeamStats(sessionId)} homeName={homeName} awayName={awayName} />
